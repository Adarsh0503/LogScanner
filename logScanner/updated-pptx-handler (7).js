    ...
    this.cleanup = function() {
        ...
        // Clear cached canvas to free memory
        cachedRenderedCanvas = null;
    ...
    // Helper function to fix top content visibility
    this.fixTopContentVisibility = function() {
        ...
        var maxScrollLeft = viewerPanel.scrollWidth - viewerPanel.clientWidth;
        if (maxScrollLeft > 0) {
            viewerPanel.scrollLeft = maxScrollLeft / 2;
        }
    };
    
    // Clone method for creating additional handler instances
    this.clone = function() {
    ...
    // Cached rendered canvas to improve performance
    var cachedCanvas = null;

    // Clone method required by InteractionController
    this.clone = function()function PptxHandler(canvas) {
    var self = this;
    self.DPI = 96; // Default DPI for PPTX files
    var pptxHtmlContent = null;
    var slideCount = 0;
